...
path_to_frame = f'/nobackup/le/LoCoNet/AVA_Dataset/clips_videos/{args.type}'
out_dir = f'/nobackup/le/LoCoNet/AVA_Dataset/clip_videos_landmark/{args.type}'
...
json_path = f'/nobackup/le/LoCoNet/AVA_Dataset/csv/landmark/{args.type}'
    ...
    for subfolder in subfolders:
        ...
        for file in files:
            ...
            for id in lips:
                ...
                if landmark_px:
                    ok = 1
                    image = cv2.circle(np.float32(image), landmark_px, radius = 1, color = WHITE_COLOR, thickness=2)
