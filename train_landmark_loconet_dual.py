...
from landmark_loconet_dual import loconet
import argparse
...
def main(gpu, world_size):
    ...
    if rank == 0:
        wandb.init(
            ...
            name=f"inject_talknce_nchannel_{cfg.n_channel}_layer_{cfg.layer}_method_{cfg.consistency_method}_lambda_{cfg.consistency_lambda}_talknce:{cfg.use_talknce}_dual",
