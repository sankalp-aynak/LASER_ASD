...
def main():
    ...
    s = loconet(cfg, n_channel=4, layer=1)
    ...
    if not cfg.use_consistency:
        ...
        if cfg.use_talknce:
            ...
            weight_path = sorted(glob.glob(f'/nobackup/le/LoCoNet/landmark/model_{cfg.n_channel}_{cfg.layer}_consistency_{cfg.consistency_method}_lambda_{cfg.consistency_lambda}_talknce:False/*'))[-3]
